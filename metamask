            ...
            (function() {
                ...
                b.prototype.on = function(e, t) {
                    ...
                    if ("data" === e)
                        ...
                        n.emittedReadable = !1,
                        n.reading ? n.length && R(this) : i(O, this))
                    }
                    return r
                }
                ,
 ...
 */
    ...
    67: [function(e, t, r) {
        "use strict";
        var n, i = "object" == typeof Reflect ? Reflect : null, s = i && "function" == typeof i.apply ? i.apply : function(e, t, r) {
        ...
        function f(e, t, r, n) {
            ...
            e._eventsCount = 0) : (void 0 !== s.newListener && (e.emit("newListener", t, r.listener ? r.listener : r),
            s = e._events),
            o = s[t]),
            void 0 === o)
                o = s[t] = r,
                ++e._eventsCount;
            else if ("function" == typeof o ? o = s[t] = n ? [r, o] : [o, r] : n ? o.unshift(r) : o.push(r),
 ...
 */
            ...
            (function() {
                ...
                b.prototype.on = function(e, t) {
                    ...
                    if ("data" === e)
                        ...
                        n.endEmitted || n.readableListening || (n.readableListening = n.needReadable = !0,
                        n.emittedReadable = !1,
                        n.reading ? n.length && R(this) : i.nextTick(O, this))
                    }
                    return r
                }
                ,
    ...
    , {
        "./_stream_duplex": 90,
        "./internal/streams/BufferList": 95,
        "./internal/streams/destroy": 96,
        "./internal/streams/stream": 97,
        _process: 88,
        "core-util-is": 57,
        events: 67,
        inherits: 71,
    ...
    102: [function(e, t, r) {
        class n {
            ...
            parseRange(e) {
                ...
                e = e.replace(s, k(this.options.includePrerelease)),
                a("hyphen replace", e),
                ...
                a("caret trim", e);
                let u = e.split(" ").map((e=>b(e, this.options))).join(" ").split(/\s+/).map((e=>O(e, this.options)));
        ...
        e.trim().replace(c[t.includePrerelease ? l.GTE0PRE : l.GTE0], ""))
          , k = e=>(t,r,n,i,s,o,a,u,c,l,f,h,d)=>`${r = w(n) ? "" : w(i) ? `>=${n}.0.0 ${e ? "-0" : ""}` : w(s) ? `>=${n}.${i}.0 ${e ? "-0" : ""}` : o ? `>=${r}` : `>=${r}${e ? "-0" : ""}`} ${u = w(c) ? "" : w(l) ? `<${+c + 1}.0.0-0` : w(f) ? `<${c}.${+l + 1}.0-0` : h ? `<=${c}.${l}.${f}-${h}` : e ? `<${c}.${l}.${+f + 1}-0` : `<=${u}`}`.trim()
          , I = (e,t,r)=>{
            for (let r = 0; r < e.length; r++)
                if (!e[r].test(t))
                    return !1;
    ...
    , {
        "./classes/comparator": 101,
        "./classes/range": 102,
        "./classes/semver": 103,
        "./functions/clean": 104,
        "./functions/cmp": 105,
        "./functions/coerce": 106,
        "./functions/compare": 109,
        "./functions/compare-build": 107,
        "./functions/compare-loose": 108,
        "./functions/diff": 110,
        "./functions/eq": 111,
        "./functions/gt": 112,
        "./functions/gte": 113,
        ...
        "./functions/parse": 120,
        "./functions/patch": 121,
        "./functions/prerelease": 122,
        "./functions/rcompare": 123,
        "./functions/rsort": 124,
        "./functions/satisfies": 125,
        "./functions/sort": 126,
        "./functions/valid": 127,
        "./internal/constants": 129,
        "./internal/identifiers": 131,
    ...
    , {
        "../functions/compare.js": 109,
        "../functions/satisfies.js": 125
    }],
    143: [function(e, t, r) {
    ...
    , {
        "../classes/comparator.js": 101,
        "../classes/range.js": 102,
        "../functions/compare.js": 109,
        "../functions/satisfies.js": 125
    }],
    144: [function(e, t, r) {
